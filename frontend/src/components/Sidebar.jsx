...
const Sidebar = ({ rol_id, userName, userEmail, setCurrentView, currentView, isSidebarOpen, setIsSidebarOpen }) => {
    ...
    return (
        <div className={`flex flex-col h-full bg-gray-900 text-white w-75 fixed md:relative z-40 shadow-2xl transition-transform duration-300 ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'}`}>
            {/* Header */}
            <div className="p-4 flex items-center justify-between border-b-2 border-gray-400 border-gl">
            ...
            {/* Navegación */}
            <nav className="flex-grow p-5 space-y-1 overflow-y-auto custom-scrollbar">
