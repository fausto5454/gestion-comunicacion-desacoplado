...
const FiltrosReportes = ({
  ...
  return (
    <div className="bg-white p-6 rounded-xl shadow-sm mb-6 grid md:grid-cols-4 gap-4 items-end border border-gray-100">
      <div className="flex flex-col gap-1">
        <label className="text-xs font-semibold text-gray-500 uppercase">Desde</label>
        <input 
          type="date" 
          className="border rounded-lg p-2 focus:ring-2 focus:ring-green-500 outline-none transition-all"
          value={fechaInicio} 
